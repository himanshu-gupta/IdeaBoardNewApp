  ...
  describe IdeasController do
    ...
    describe "DELETE destroy" do
      it "destroys the corresponding idea" do
        idea = @agenda.ideas.create!(valid_attributes)
          delete :destroy, {:agenda_id => @agenda.id.to_param, :id => idea.to_param}
      end

      it "redirects to the agenda and ideas list" do
        idea = @agenda.ideas.create!(valid_attributes)
        delete :destroy, {:agenda_id => @agenda.id.to_param, :id => idea.to_param}
        response.should redirect_to agenda_path(@agenda)
      end
